...
export default function ViolationsTable({ violations, onRowClick, activeId }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-soft overflow-hidden border border-gray-100 dark:border-gray-800">
      ...
      {/* ✅ ADDED: Mobile Scroll Wrapper */}
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          {/* TABLE HEADER */}
          <thead className="bg-gray-50 dark:bg-gray-800/50">
            <tr>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 whitespace-nowrap">Rule</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 whitespace-nowrap">Impact</th>
              <th className="p-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 whitespace-nowrap">Elements</th>
              <th className="p-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 whitespace-nowrap">Details</th>
            </tr>
          </thead>
            ...
            {violations.map((v, index) => {
              ...
              return (
                <Fragment key={v.id || index}>
                  ...
                  >
                    {/* RULE ID */}
                    <td className="p-4 font-mono text-sm font-semibold text-gray-800 dark:text-gray-100 whitespace-nowrap">
                      {v.id}
                    </td>
